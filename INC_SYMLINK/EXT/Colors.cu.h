...
class Colors
	...
	static void HSB_TO_RVB(const float4& hsb01 , uchar4* ptrRVBA)
	    {
	    Colors::HSB_TO_RVB(hsb01.x, hsb01.y, hsb01.z, &ptrRVBA->x, &ptrRVBA->y, &ptrRVBA->z);
	...
	static void HSB_TO_RVB(float h01 , uchar4* ptrRVBA)
	    {
	    Colors::HSB_TO_RVB(h01, 1.0f, 1.0f, &ptrRVBA->x, &ptrRVBA->y, &ptrRVBA->z);
	    ptrRVBA->w = 255;  //opaque;
	    }
	...
	static void HSB_TO_RVB(float H , float S , float V , uchar4* ptrRVBA)
	    {
	    Colors::HSB_TO_RVB(H, S, V, &ptrRVBA->x, &ptrRVBA->y, &ptrRVBA->z);
	    ptrRVBA->w = 255; //opaque;
	    }
	...
	static void HSB_TO_RVB(const float3& hsb01 , uchar3* ptrRVB)
	    {
	    Colors::HSB_TO_RVB(hsb01.x, hsb01.y, hsb01.z, &ptrRVB->x, &ptrRVB->y, &ptrRVB->z);
	    }
	...
	static void HSB_TO_RVB(float h01 , uchar3* ptrRVB)
	    {
	    Colors::HSB_TO_RVB(h01, 1.0f, 1.0f, &ptrRVB->x, &ptrRVB->y, &ptrRVB->z);
	    }
	...
	static void HSB_TO_RVB(const float4& hsba01 , float4* ptrRVBA)
	    {
	    Colors::HSB_TO_RVB(hsba01.x, hsba01.y, hsba01.z, &ptrRVBA->x, &ptrRVBA->y, &ptrRVBA->z);
	    ptrRVBA->w = hsba01.w;
	    }
