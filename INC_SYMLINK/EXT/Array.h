 ...
 * 		- un operateur =
 *
 * 	Dans les deux cas, les attributs sont copiers bit � bit!
 * 	� moins qu'un cc ou une surcharge de = existe.
 *
 * Consequence:
 *
 * 	Si une classe possede un attribut de type ptr, lors d'une copie par CC ou =, l'adresse sera copie bit � bit.
 * 	On se retrouvera non pas avec un clone mais avec une adresse partagre dans deux instances!
 * 	Le deuxieme objet detruit ne pourra pas d�truire sont attributs de type ptr!
 *
 ...
 *
 *      et ceci de mani�re recursive sur les objets inclus dans l'element pointer par ptr!
 *
 * Constraints :
 *
