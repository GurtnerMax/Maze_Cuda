...
// astuce: permet de travailler avec une methode static sans classe derivant interface
...
class Viewer
	...
	gpu::GLUTImageViewers* getGlutImageViewers()
	    {
	    return &glutViewer;
	    }
	...
	// Tools
	gpu::GLUTImageViewers glutViewer;
